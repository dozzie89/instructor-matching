...
def generate_edges():
    ...
    for instruct_outer in instructors:
        ...
        for instruct_inner in instructors:
            ...
            #if((get_name(instruct_outer) == 'Joice Hu' and get_name(instruct_inner) == 'Geoff Brennecka') 
                #or (get_name(instruct_inner) == 'Joice Hu' and get_name(instruct_outer) == 'Geoff Brennecka')):
                #print(get_name(instruct_outer), outer_timeline)
                #print(get_name(instruct_inner), inner_timeline)
